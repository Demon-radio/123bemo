...
const translations: LanguageContent = {
  en: {
    heroTitle: "Welcome to BMO Tools",
    heroSubtitle: "Creating engaging content across social media platforms",
    exploreContent: "Explore Content",
    playGames: "Play Games",
    connectWithMe: "Connect With Me",
    gamesTitle: "BMO Games",
    aboutTitle: "About BMO Tools",
    contentTitle: "Latest Content",
    connectTitle: "Connect with BMO Tools",
    footerText: "BMO Tools - Content Creator & Gaming Enthusiast",
    ...
    aboutDescription1: "Welcome to my digital universe! I'm the creator behind BMO Tools, passionate about technology, gaming, and creating engaging content that connects with audiences across multiple platforms.",
    ...
    aboutDescription3: "My mission is to create content that not only entertains but also informs and inspires. Whether you're here for tech reviews, gaming streams, or just to connect with like-minded individuals, BMO Tools is your digital home.",
    videos: "Videos",
    followers: "Followers",
    years: "Years",
    platforms: "Platforms"
  ...
  ar: {
    heroTitle: "مرحباً بكم في أدوات BMO",
    ...
    gamesTitle: "ألعاب BMO",
    aboutTitle: "حول أدوات BMO",
    contentTitle: "أحدث المحتوى",
    connectTitle: "تواصل مع أدوات BMO",
    footerText: "أدوات BMO - منشئ محتوى وعاشق للألعاب",
    ...
    contactMe: "تواصل معي",
    aboutDescription1: "مرحباً بكم في عالمي الرقمي! أنا منشئ أدوات BMO، شغوف بالتكنولوجيا والألعاب وإنشاء محتوى جذاب يتواصل مع الجماهير عبر منصات متعددة.",
    ...
    aboutDescription3: "مهمتي هي إنشاء محتوى لا يسلي فقط بل يعلم ويلهم أيضاً. سواء كنت هنا لمراجعات التقنية أو البث المباشر للألعاب أو مجرد التواصل مع أشخاص متشابهين في التفكير، أدوات BMO هو منزلك الرقمي.",
    videos: "فيديوهات",
    followers: "متابعين",
    years: "سنوات",
    platforms: "منصات"
  ...
  es: {
    ...
    aboutDescription1: "¡Bienvenido a mi universo digital! Soy el creador detrás de BMO Tools, apasionado por la tecnología, los juegos y la creación de contenido atractivo que conecta con audiencias en múltiples plataformas.",
    ...
    aboutDescription3: "Mi misión es crear contenido que no solo entretenga sino que también informe e inspire. Ya sea que estés aquí para reseñas de tecnología, transmisiones de juegos o simplemente para conectarte con personas afines, BMO Tools es tu hogar digital.",
    videos: "Videos",
  ...
  fr: {
    ...
    aboutDescription1: "Bienvenue dans mon univers numérique ! Je suis le créateur derrière BMO Tools, passionné par la technologie, les jeux et la création de contenu engageant qui connecte avec les audiences sur plusieurs plateformes.",
    ...
    aboutDescription3: "Ma mission est de créer du contenu qui non seulement divertit mais aussi informe et inspire. Que vous soyez ici pour des critiques tech, des streams de jeux ou simplement pour vous connecter avec des personnes partageant les mêmes idées, BMO Tools est votre maison numérique.",
    videos: "Vidéos",
    followers: "Abonnés",
    years: "Années",
  ...
  de: {
    ...
    aboutDescription1: "Willkommen in meinem digitalen Universum! Ich bin der Schöpfer hinter BMO Tools, leidenschaftlich über Technologie, Gaming und die Erstellung ansprechender Inhalte, die mit Audiences auf mehreren Plattformen verbinden.",
    ...
    aboutDescription3: "Meine Mission ist es, Inhalte zu erstellen, die nicht nur unterhalten, sondern auch informieren und inspirieren. Ob Sie hier für Tech-Reviews, Gaming-Streams oder einfach nur sind, um sich mit Gleichgesinnten zu verbinden, BMO Tools ist Ihr digitales Zuhause.",
    videos: "Videos",
    followers: "Follower",
    years: "Jahre",
  ...
  ja: {
    ...
    contactMe: "お問い合わせ",
    aboutDescription1: "私のデジタル宇宙へようこそ！私はBMO Toolsの背後にあるクリエイターで、テクノロジー、ゲーム、そして複数のプラットフォームでオーディエンスとつながる魅力的なコンテンツの作成に情熱を持っています。",
    aboutDescription2: "趣味として始まったものが、コンテンツ作成の専門的な旅に発展し、成長するフォロワーコミュニティと私の経験、洞察、エンターテイメントを共有しています。",
    aboutDescription3: "私のミッションは、単に楽しませるだけでなく、情報を提供し、インスピレーションを与えるコンテンツを作成することです。テクノロジーのレビュー、ゲーミングストリーミング、または同じ志を持つ個人とのつながりのためにここにいる場合でも、BMO Toolsはあなたのデジタルホームです。",
    videos: "動画",
    followers: "フォロワー",
    years: "年",
    platforms: "プラットフォーム"
  ...
  ko: {
    ...
    contactMe: "연락하기",
    aboutDescription1: "디지털 우주에 오신 것을 환영합니다! 저는 BMO Tools의 창작자로, 기술, 게임, 그리고 여러 플랫폼에서 관객과 연결하는 매력적인 콘텐츠 제작에 열정을 가지고 있습니다.",
    aboutDescription2: "취미로 시작된 것이 콘텐츠 제작의 전문적인 여정으로 발전했으며, 성장하는 팔로워 커뮤니티와 경험, 통찰력, 엔터테인먼트를 공유하고 있습니다.",
    aboutDescription3: "제 사명은 단순히 즐겁게 하는 것뿐만 아니라 정보를 제공하고 영감을 주는 콘텐츠를 만드는 것입니다. 기술 리뷰, 게임 스트리밍, 또는 단순히 같은 생각을 가진 사람들과 연결하기 위해 여기 계시든, BMO Tools는 여러분의 디지털 홈입니다.",
    videos: "동영상",
    followers: "팔로워",
    years: "년",
    platforms: "플랫폼"
  ...
  zh: {
    ...
    contactMe: "联系我",
    aboutDescription1: "欢迎来到我的数字宇宙！我是BMO Tools背后的创作者，对技术、游戏以及创建在多个平台上与观众连接的引人入胜内容充满热情。",
    aboutDescription2: "从一个爱好开始，发展成为专门的内容创作之旅，我与不断增长的关注者社区分享我的经验、见解和娱乐内容。",
    aboutDescription3: "我的使命是创建不仅娱乐而且提供信息和启发的内容。无论您是来看技术评论、游戏直播，还是只是想与志同道合的人联系，BMO Tools都是您的数字家园。",
    videos: "视频",
    followers: "关注者",
    years: "年",
    platforms: "平台"
